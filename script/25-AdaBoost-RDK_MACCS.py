...
for file_name in csv_files:
    ...
    combined_fingerprints = [rdk + maccs for rdk, maccs in zip(RDK_fingerprints, MACCS_fingerprints)]
    ...
    model_filename = "25-AdaBoost-RDK_MACCS-" + file_name.split('.')[0] + "-model.joblib"
    dump(best_model, model_filename)

    # Save the best parameters
    best_params_name = "25-AdaBoost-RDK_MACCS-" + file_name.split('.')[0] + "-best_params.txt"
    ...
    results_name = "25-AdaBoost-RDK_MACCS-" + file_name.split('.')[0] + "-results.txt"
    results = {
    ...
    cv_scores_name = "25-AdaBoost-RDK_MACCS-" + file_name.split('.')[0] + "-cv_scores.txt"
    ...
    plt.title('25-AdaBoost-RDK_MACCS Prediction', fontsize=16)
    ...
    # Save the image
    image_name = "25-AdaBoost-RDK_MACCS-" + file_name.split('.')[0] + ".png"
