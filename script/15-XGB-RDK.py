...
for file_name in csv_files:
    ...
    model_filename = "15-XGB-RDK-" + file_name.split('.')[0] + "-model.joblib"
    dump(best_model, model_filename)

    # Save the best parameters
    best_params_name = "15-XGB-RDK-" + file_name.split('.')[0] + "-best_params.txt"
    ...
    results_name = "15-XGB-RDK-" + file_name.split('.')[0] + "-results.txt"
    results = {
    ...
    cv_scores_name = "15-XGB-RDK-" + file_name.split('.')[0] + "-cv_scores.txt"
    ...
    plt.title('15-XGB-RDK Prediction', fontsize=16)
    ...
    # Save the image
    image_name = "15-XGB-RDK-" + file_name.split('.')[0] + ".png"
