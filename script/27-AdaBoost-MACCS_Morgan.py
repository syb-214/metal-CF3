...
for file_name in csv_files:
    ...
    combined_fingerprints = [maccs + morgan for maccs, morgan in zip(MACCS_fingerprints, Morgan_fingerprints)]
    ...
    model_filename = "27-AdaBoost-MACCS_Morgan-" + file_name.split('.')[0] + "-model.joblib"
    dump(best_model, model_filename)

    # Save the best parameters
    best_params_name = "27-AdaBoost-MACCS_Morgan-" + file_name.split('.')[0] + "-best_params.txt"
    ...
    results_name = "27-AdaBoost-MACCS_Morgan-" + file_name.split('.')[0] + "-results.txt"
    results = {
    ...
    cv_scores_name = "27-AdaBoost-MACCS_Morgan-" + file_name.split('.')[0] + "-cv_scores.txt"
    ...
    plt.title('27-AdaBoost-MACCS_Morgan Prediction', fontsize=16)
    ...
    # Save the image
    image_name = "27-AdaBoost-MACCS_Morgan-" + file_name.split('.')[0] + ".png"
