...
for file_name in csv_files:
    ...
    model_filename = "18-XGB-RDK_MACCS-" + file_name.split('.')[0] + "-model.joblib"
    dump(best_model, model_filename)

    # Save the best parameters
    best_params_name = "18-XGB-RDK_MACCS-" + file_name.split('.')[0] + "-best_params.txt"
    ...
    results_name = "18-XGB-RDK_MACCS-" + file_name.split('.')[0] + "-results.txt"
    results = {
    ...
    cv_scores_name = "18-XGB-RDK_MACCS-" + file_name.split('.')[0] + "-cv_scores.txt"
    ...
    plt.title('18-XGB-RDK_MACCS Prediction', fontsize=16)
    ...
    # Save the image
    image_name = "18-XGB-RDK_MACCS-" + file_name.split('.')[0] + ".png"
